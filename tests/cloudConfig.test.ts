...
describe("loadCloudConfig — defaults", () => {
  it("uses mistral-large-3:675b-cloud (non-thinking) across generative tiers, ollama.com host, 32768 num_ctx", () => {
    ...
    expect(cfg.tiers.instant).toBe("mistral-large-3:675b-cloud");
    expect(cfg.tiers.workhorse).toBe("mistral-large-3:675b-cloud");
    expect(cfg.tiers.deep).toBe("mistral-large-3:675b-cloud");
