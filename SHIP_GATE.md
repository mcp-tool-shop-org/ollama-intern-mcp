...
**Release:** v<!-- VERSION:start -->2.6.0<!-- VERSION:end --> (2026-05-12)
...
- [x] `[all]` `verify` script exists (test + build + smoke in one command) (2026-05-12) — `npm run verify` = typecheck + build + test; <!-- TEST_COUNT:start -->968<!-- TEST_COUNT:end --> tests pass
- [x] `[all]` Version in manifest matches git tag (2026-05-12) — v<!-- VERSION:start -->2.6.0<!-- VERSION:end --> in package.json, tagged on publish; `src/version.ts` drift fixed in v2.3.0 (now reads from `package.json`)
