...
क्लाउड कोड के लिए स्थानीय इंटर्न। 42 उपकरण, जो नौकरी के लिए उपयोगी हैं; साक्ष्य-आधारित रिपोर्ट; टिकाऊ सामग्री।
...
## नया संस्करण v2.6.0 में:

`ollama_extract` पर प्रति-कॉल स्तर-बजट ओवरराइड। मामूली अतिरिक्त सुविधा — v2.6.0 से पहले के उपयोगकर्ताओं पर कोई प्रभाव नहीं। विस्तृत जानकारी [CHANGELOG.md](./CHANGELOG.md) में उपलब्ध है।

- **`ollama_extract` पर `tier_budget_ms_override?: number` स्कीमा फ़ील्ड** (वैकल्पिक, सीमांकित `[1, 600000]` मिलीसेकंड)। जब यह मौजूद होता है, तो यह रनर द्वारा विज़िट किए गए प्रत्येक स्तर पर लागू होता है, ताकि `src/guardrails/timeouts.ts:61` पर आंतरिक `runWithTimeoutAndFallback` तंत्र, प्रोफाइल की डिफ़ॉल्ट सेटिंग के बजाय, ऑपरेटर द्वारा प्रदान किए गए बजट का पालन करे। कैस्केड (वर्कहॉर्स → टाइमआउट पर इंस्टेंट) अभी भी सक्रिय रहता है; ओवरराइड प्रत्येक कैस्केड चरण को समान रूप से नियंत्रित करता है।
- **यह क्यों मौजूद है।** रिसर्च-ओएस R-018 रैपर (v0.12.1) ने MCP `callTool` को `Promise.race` के साथ लपेटा और पाया कि रैपर का बजट आंतरिक स्तर तक नहीं पहुंच रहा था — `DEV_RTX5080_TIMEOUTS.instant = 15_000` 15000ms पर `TIER_TIMEOUT` को जारी रखता था, भले ही रैपर का बजट 180000ms था। v2.6.0 MCP-साइड पर आधिकारिक बजट प्रदान करता है, ताकि ऑपरेटर का `--planner-timeout-ms` फ़्लैग (रिसर्च-ओएस) अंततः, जैसा कि डिज़ाइन किया गया है, आंतरिक-स्तरीय टाइमआउट को नियंत्रित कर सके।
- **डिफ़ॉल्ट व्यवहार संरक्षित।** यदि फ़ील्ड छोड़ा गया है, तो प्रोफाइल डिफ़ॉल्ट सेटिंग्स लागू होती हैं। v2.6.0 से पहले के उपयोगकर्ताओं को कोई बदलाव नहीं दिखाई देगा।
- **R-010 फ़ॉलबैक-कारण रेगुलर एक्सप्रेशन संरक्षित।** सर्वर-साइड `TIER_TIMEOUT` त्रुटि संदेश अभी भी `/elapsed=(\d+)ms/` + `/budget=(\d+)ms/` से मेल खाता है, इसलिए AI-सलाहकार की दृश्यता, ओवरराइड और डिफ़ॉल्ट दोनों रास्तों पर काम करती है।
- रिसर्च-ओएस v0.13.0 द्वारा उपयोग किया गया (R-019 क्लाइंट वायर-अप + R-020 + R-021 का संचयी संस्करण) एक समन्वित मल्टी-रिपो रिलीज़ में।

### ऐतिहासिक — v2.4.0 रिलीज़

पूरे v2.4.0 विवरण के लिए, [CHANGELOG.md](./CHANGELOG.md) और [docs/release-notes/v2.4.0.md](./docs/release-notes/v2.4.0.md) देखें (प्रोफाइल सिस्टम पर प्रति-स्तर `num_ctx` नियंत्रण)।

## संस्करण 2.4.0 में नए अपडेट:

प्रत्येक स्तर पर `num_ctx` (संदर्भ विंडो) को नियंत्रित करने की सुविधा प्रोफाइल सिस्टम में जोड़ी गई है। यह एक मामूली बदलाव है, और इससे v2.3.0 के उपयोगकर्ताओं पर कोई प्रभाव नहीं पड़ेगा। विस्तृत जानकारी [CHANGELOG.md](./CHANGELOG.md) और [docs/release-notes/v2.4.0.md](./docs/release-notes/v2.4.0.md) में उपलब्ध है।

- **`TierConfig.num_ctx` मैप (नया)** — प्रोफाइल पर वैकल्पिक `{ instant?, workhorse?, deep?, embed? }` विकल्प। जब किसी टियर के लिए यह सेट किया जाता है, तो MCP सर्वर हर उस ओलामा जेनरेट/चैट अनुरोध पर `options.num_ctx = <value>` सेट करता है जो उस टियर पर रूट किया जाता है (प्रारंभिक + बैकअप)। यदि यह सेट नहीं है, तो अनुरोध से `num_ctx` पूरी तरह से हटा दिया जाता है, इसलिए ओलामा अपने मॉडल-लोड किए गए डिफ़ॉल्ट मान का उपयोग करता है — v2.3.0 का व्यवहार बिल्कुल वैसा ही बना रहता है।
- **नया एनवेलप फ़ील्ड `num_ctx_used?: number`** — यह केवल तभी मौजूद होता है जब MCP सर्वर ने वास्तव में `num_ctx` भेजा हो। यदि अनुरोध में ओलामा को चुनने दिया गया था, तो यह अनुपस्थित होता है। कोई डिफ़ॉल्ट मान न मानें — MCP सर्वर ओलामा से प्रभावी मान के लिए कोई क्वेरी नहीं करता है।
- **प्रोफाइल डिफ़ॉल्ट:** `dev-rtx5080` / `dev-rtx5080-qwen3` में `instant: 4096`, `workhorse: 8192`, `deep`/`embed` अनसेट हैं। इन्हें इस तरह से डिज़ाइन किया गया है कि `hermes3:8b` को RTX 5080 की 16GB VRAM मेमोरी में रखा जा सके, ताकि तेज़ टूल का उपयोग किया जा सके। `m5-max` में हर टियर अनसेट है — 128GB की एकीकृत मेमोरी में कोई मेमोरी ओवरफ्लो की समस्या नहीं होती है।
- **v0.8.0 के चरण 1 का निदान समाप्त करता है** — `hermes3:8b` को डिफ़ॉल्ट 32K संदर्भ पर RTX 5080 पर चलाने पर, यह CPU में स्थानांतरित हो गया और `ollama_extract` के "वर्कहॉर्स" कार्यों में समय-सीमा समाप्त होने लगी। v2.4.0 इस समस्या को प्रोफाइल स्तर पर रोकता है।

### प्रत्येक स्तर के लिए `num_ctx` को नियंत्रित करने की सुविधा (संस्करण 2.4.0 में नई)।

प्रोफ़ाइल (स्रोत फ़ाइल `src/profiles.ts` से उद्धरण):
...
"वर्कहॉर्स" श्रेणी के किसी कार्य (जैसे `ollama_extract`) के लिए उपयोग किए जाने वाले एन्वलप का विवरण:
...
`m5-max` (या किसी भी ऐसे प्रोफाइल में जो किसी विशेष स्तर को परिभाषित नहीं करता है), `num_ctx_used` डेटा पैकेट में मौजूद नहीं होता है, और ओलामा को भेजे गए अनुरोध में `num_ctx` फ़ील्ड शामिल नहीं होता है - ओलामा अपने मॉडल में पहले से निर्धारित डिफ़ॉल्ट मान का उपयोग करता है।

ऑपरेटर प्रोफाइल का चयन करके/संपादित करके ट्यूनिंग करते हैं; टूल स्कीमा में प्रत्येक कॉल के लिए `num_ctx` का कोई अलग इनपुट नहीं होता है। यदि भविष्य में किसी कॉल में इसकी आवश्यकता महसूस होती है, तो यह v2.3.0 के `model` ओवरराइड पैटर्न का अनुसरण करेगा।

### ऐतिहासिक - संस्करण 2.3.0 के कार्य।

विस्तृत जानकारी के लिए, संस्करण 2.3.0 में किए गए परिवर्तनों (प्रत्येक कॉल के लिए मॉडल को बदलने की सुविधा) के बारे में जानने के लिए [CHANGELOG.md](./CHANGELOG.md) और [docs/release-notes/v2.3.0.md](./docs/release-notes/v2.3.0.md) देखें।

## संस्करण 2.3.0 में नए अपडेट:
...
### ऐतिहासिक - संस्करण 2.2.0 के लिए अपेक्षित परिणाम।
...
## आर्किटेक्चर: एक संक्षिप्त विवरण
...
प्रत्येक क्लाउड टूल का अनुरोध, `stdio JSON-RPC` के माध्यम से एमसीपी सर्वर तक पहुंचता है। सर्वर, टूल के `zod` (https://zod.dev) स्कीमा के अनुसार अनुरोध को सत्यापित करता है, फिर कॉन्फ़िगर किए गए सुरक्षा उपायों (जैसे, संदर्भ सत्यापन, प्रतिबंधित शब्दों को हटाना, संरक्षित फ़ाइलों की सुरक्षा, और निश्चितता सीमा) को लागू करता है। इसके बाद, यह या तो एक पूर्वनिर्धारित रेंडरर (आर्टिफैक्ट स्तर) या एक `Ollama HTTP` अनुरोध (अन्य सभी स्तरों के लिए) को भेजता है। `Ollama` डेमॉन कभी भी उपयोगकर्ता द्वारा प्रदान किए गए फ़ाइल पथों को नहीं देखता है - केवल मॉडल स्तर और तैयार किए गए प्रॉम्प्ट को देखता है। प्रत्येक अनुरोध, `~/.ollama-intern/log.ndjson` पर स्थित `NDJSON` लॉग में एक संरचित घटना जोड़ता है, जिसे `ollama_log_tail` और आपका शेल पढ़ सकता है।
...
## इसमें क्या है - चार स्तर, और 42 उपकरण।
...
|---|---|---|
| **Atoms** | 28 | नौकरी-उन्मुख बुनियादी कार्य। **मूल 15:** `वर्गीकृत करें`, `निकालें`, `लॉग का विश्लेषण करें`, `तेजी से सारांशित करें` / `गहराई से`; `मसौदा तैयार करें`, `अनुसंधान करें`, `कोर्पस खोजें` / `उत्तर दें` / `इंडेक्स बनाएं` / `ताज़ा करें` / `सूची बनाएं`, `खोज को एम्बेड करें`, `एम्बेड करें`, `चैट करें। **v2.1.0 में जोड़े गए 13:** `डॉक्टर`, `लॉग टेल`, `बैच प्रूफ चेक` (ऑपरेशन); `कोड मैप`, `कोड उद्धरण`, `मल्टी-फाइल रिफैक्टर का प्रस्ताव`, `रिफैक्टर योजना` (रिफैक्टर); `आर्टिफैक्ट को हटाएं`, `परिकल्पना का विश्लेषण करें` (आर्टिफैक्ट/संक्षिप्त विवरण); `कोर्पस स्वास्थ्य`, `कोर्पस में संशोधन करें`, `कोर्पस संशोधन इतिहास`, `कोर्पस को फिर से रैंक करें` (कोर्पस)। बैच-सक्षम कार्य (`वर्गीकृत करें`, `निकालें`, `लॉग का विश्लेषण करें`) `items: [{id, text}]` स्वीकार करते हैं। |
...
कुल: **28 परमाणु + 3 संक्षिप्त विवरण + 3 पैकेज + 7 कलाकृतियाँ = <!-- TOOL_COUNT:start -->42<!-- TOOL_COUNT:end -->**.

स्थिर किए गए तत्व:
- परमाणु: v2.1.0 में **स्थिरता हटा दी गई** (आज 28; v2.1.0 में 13 नए जोड़े गए)। नए परमाणुओं के लिए अभी भी एक उचित अंतराल, परीक्षण, हैंडबुक पृष्ठ और CHANGELOG प्रविष्टि की आवश्यकता होती है — कोई भी बिना उचित कारण जोड़े नहीं जाएगा।
- पैकेज: 3 पर स्थिर। कोई नया पैकेज प्रकार नहीं।
- कलाकृति स्तर: 7 पर स्थिर।
...
प्रत्येक स्तर पर बदलाव। पैकेज और कलाकृति स्तर 3 और 7 पर स्थिर रहेंगे। परमाणुओं की स्थिरता v2.1.0 में हटा दी गई थी — नए परमाणुओं के लिए एक उचित अंतराल, परीक्षण, हैंडबुक पृष्ठ और CHANGELOG प्रविष्टि की आवश्यकता होती है।
