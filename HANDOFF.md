...
**Status:** v<!-- VERSION:start -->2.10.0<!-- VERSION:end --> published · <!-- TOOL_COUNT:start -->44<!-- TOOL_COUNT:end --> tools (atoms + briefs + packs + artifact tier) · <!-- TEST_COUNT:start -->1215<!-- TEST_COUNT:end --> tests · CI green
...
## Tool surface (<!-- TOOL_COUNT:start -->44<!-- TOOL_COUNT:end --> tools, 4 tiers — freeze lifted at v2.1.0)
...
npm ci
npm run verify   # typecheck + build + <!-- TEST_COUNT:start -->1215<!-- TEST_COUNT:end --> tests
```
...
npm run verify
# Expected: typecheck clean, build clean, <!-- TEST_COUNT:start -->1215<!-- TEST_COUNT:end --> tests passing
