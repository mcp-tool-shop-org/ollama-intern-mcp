...
**Status:** v<!-- VERSION:start -->2.7.2<!-- VERSION:end --> published · <!-- TOOL_COUNT:start -->42<!-- TOOL_COUNT:end --> tools (atoms + briefs + packs + artifact tier) · <!-- TEST_COUNT:start -->1006<!-- TEST_COUNT:end --> tests · CI green
...
npm ci
npm run verify   # typecheck + build + <!-- TEST_COUNT:start -->1006<!-- TEST_COUNT:end --> tests
```
...
npm run verify
# Expected: typecheck clean, build clean, <!-- TEST_COUNT:start -->1006<!-- TEST_COUNT:end --> tests passing
