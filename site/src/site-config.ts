...
export const config: SiteConfig = {
  ...
  description:
    'The local intern for Claude Code — 43 job-shaped tools, evidence-first briefs, durable artifacts.',
  logoBadge: 'OI',
  ...
  hero: {
    ...
    description:
      '43 job-shaped tools across four tiers — atoms, briefs, packs, artifacts. Claude picks the tool, the tool picks the tier, the tier writes a file you can open next week. Local-first and zero-egress by default, with optional Ollama Cloud routing for 600B-class models when local hardware is the bottleneck. No telemetry. Every call shows its work.',
  ...
  sections: [
    {
      kind: 'features',
      id: 'shape',
      title: 'The shape — four tiers, 43 tools',
